package com.ayyappan.androidapp.wedlock.imageslideshow.adapter;
...
public class ImageSlideAdapter extends PagerAdapter {
    ...
    public ImageSlideAdapter(FragmentActivity activity, List<Image> products,
                             ImageViewerFragment homeFragment) {
    ...
    public View instantiateItem(ViewGroup container, final int position) {
        ...
        mImageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Image product = (Image) products.get(position);
        ...
        imageLoader.displayImage(
                ((Image) products.get(position)).getImageUrl(), mImageView,
