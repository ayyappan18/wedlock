 ...
 */
public class ImagePagerFragment extends FragmentActivity {
	...
	//	onCreateDrawer();
		...
		pager.setAdapter(new ImageAdapter(getApplicationContext()));
		pager.setCurrentItem(getIntent().getIntExtra(Constants.Extra.IMAGE_POSITION, 0));
	}
	...
	private static class ImageAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup view, int position) {
			...
			View imageLayout = inflater.inflate(R.layout.fr_item_pager_image, view, false);
